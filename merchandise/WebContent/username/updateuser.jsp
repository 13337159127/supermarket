	...
	<div class="wrapper">
		<div class="sidebar" data-background-color="white"
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					<li class="active"><a href="FondCommodity"> <i class="ti-panel"></i>
							<p>返回首页</p>
					</a></li>
					<li><a href="/merchandise/FondAddCommoditys"> <i class="ti-user"></i>
							<p>添加商品</p>
					</a></li>
		...
		<div class="main-panel">
			...
			<div class="content">
				...
				<form action="/merchandise/UpdateUserName" method="get">				
